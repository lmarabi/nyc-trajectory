...
//    	String input = "./data/Long2Int.txt";
    	String input = "/export/scratch/mntgData/nyc_networkGraph/LargeNYC/newgraph.txt";
    	String startNodeID = "1";
        In in = new In(input);
        EdgeWeightedDigraph G = new EdgeWeightedDigraph(in, true);
        int s = Integer.parseInt(startNodeID);

        
        DijkstraSP sp = new DijkstraSP(G, s);
        
        System.out.println(sp.pathTo(1343312));
        
        System.out.println(sp.distTo(1343312));
...
//        for (int t = 0; t < G.V(); t++) {
//            if (sp.hasPathTo(t)) {
//                StdOut.printf("%d to %d (%.8f)  ", s, t, sp.distTo(t));
//                if (sp.hasPathTo(t)) {
