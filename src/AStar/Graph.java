...
//                continue;
    ...
    public static class Vertex<T extends Comparable<T>> implements Comparable<Vertex<T>> {
        ...
        public Vertex(T value,double lat, double lon) {
            this.value = value;
            this.latitude = lat;
            this.longtitude = lon;
        }

        public Vertex(T value, int weight, double lat, double lon) {
            this(value,lat,lon);
            this.weight = weight;
        }
        ...
        public Vertex(Vertex<T> vertex) {
            this(vertex.value, vertex.weight, vertex.latitude,vertex.longtitude);
    ...
    public static class Edge<T extends Comparable<T>> implements Comparable<Edge<T>> {
        ...
        @Override
        public int hashCode() {
            final double cost = (this.cost * (this.getFromVertex().hashCode() * this.getToVertex().hashCode())); 
            return (int) (31 * cost);
        }
